...
const LADINO: ClassDescription = {
  name: "Ladino",
  description:
    "Mestres da furtividade e especialistas em habilidades variadas, os ladinos são os sobreviventes das ruas e das sombras. Eles não buscam o confronto direto, preferindo a astúcia e a precisão de um ataque inesperado. Seja desarmando armadilhas ou abrindo fechaduras impossíveis, o ladino é indispensável para qualquer grupo que deseje explorar lugares proibidos.",
