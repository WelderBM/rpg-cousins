...
const BARDO: ClassDescription = {
  name: "Bardo",
  description:
    "Para o bardo, a vida é uma canção e o mundo é seu palco. Viajantes, contadores de histórias e músicos, eles usam sua arte para inspirar coragem em seus aliados e semear confusão entre seus inimigos. Com um pé na magia e outro na perícia, os bardos são versáteis e adaptáveis, sempre prontos para transformar um encontro comum em uma saga lendária.",
  detailedProficiencies: "Armas simples e marciais, armaduras leves e escudos.",
  pv: 12,
  addpv: 3,
  pm: 4,
  addpm: 4,
