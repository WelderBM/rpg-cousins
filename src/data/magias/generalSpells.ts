...
export const spellsCircle1: Record<spellsCircle1Names, Spell> = {
  ...
  [spellsCircle1Names.aviso]: {
    ...
    school: "Adiv",
    description:
      "Envia um aviso telepático para uma criatura. Escolha um dos efeitos: Mensagem (o alvo ouve uma mensagem de até 25 palavras), Localização (você sabe a direção e distância do alvo) ou Alarme (você é alertado se o alvo entrar em combate).",
    aprimoramentos: [
      {
        addPm: 1,
  ...
  [spellsCircle1Names.comando]: {
    ...
    school: "Encan",
    description:
      "Você dá uma ordem irresistível que o alvo deve obedecer. Escolha um dos efeitos: Fuja (o alvo se afasta), Largue (o alvo solta o que segura), Pare (o alvo fica pasmo), Caia (o alvo cai no chão) ou Venha (o alvo se aproxima).",
    aprimoramentos: [
      {
        addPm: 1,
        text: "muda o alvo para 1 criatura.",
  ...
  [spellsCircle1Names.conjurarMonstro]: {
    ...
    school: "Conv",
    description:
      "Você conjura um monstro que ataca seus inimigos. Você escolhe a aparência e o tipo de dano. O monstro age no início de seus turnos e pode receber ordens como: Mover (o monstro se desloca), Atacar (o monstro realiza um ataque) ou Flanquear (o monstro se posiciona para ajudar em um flanco).",
    aprimoramentos: [
      {
        addPm: 1,
...
export const spellsCircle2: Record<spellsCircle2Names, Spell> = {
  ...
  [spellsCircle2Names.controlarFogo]: {
    ...
    school: "Evoc",
    description:
      "Você pode criar, moldar, mover ou extinguir chamas. Escolha um dos efeitos: Apagar (extingue chamas na área), Chamejar (causa 1d6 de dano de fogo em um alvo), Mover (desloca o fogo 3m) ou Moldar (cria formas simples com as chamas).",
    aprimoramentos: [
      {
        addPm: 1,
  ...
  [spellsCircle2Names.rogarMaldicao]: {
    ...
    school: "Necro",
    description:
      "Você entoa cânticos maléficos que amaldiçoam uma vítima. Escolha um dos efeitos: Fraqueza (–2 em testes de Força e Destreza), Lentidão (deslocamento reduzido à metade), Vulnerabilidade (–2 na Defesa) ou Fadiga (o alvo fica fatigado).",
    aprimoramentos: [
      {
        addPm: 3,
...
export const spellsCircle5: Record<spellsCircle5Names, Spell> = {
  ...
  [spellsCircle5Names.controlarOTempo]: {
    ...
    school: "Trans",
    description:
      "Você altera o fluxo do tempo ao seu redor. Escolha um dos efeitos: Acelerar (você recebe uma ação padrão adicional), Retardar (inimigos na área ficam lentos) ou Parar (o tempo para para todos exceto você por 1d4 rodadas).",
  },
  [spellsCircle5Names.desejo]: {
    ...
    school: "Trans",
    description:
      "A magia mais poderosa de Arton. Pode duplicar qualquer magia de 4º círculo ou menor, restaurar todos os PV e PM de uma criatura, remover qualquer condição negativa, criar itens de até T$ 25.000 ou conceder um bônus permanente de +1 em um atributo.",
  },
};
