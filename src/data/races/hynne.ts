...
const HYNNE: Race = {
  name: "Hynne",
  description:
    "Pequenos, ágeis e amantes do conforto, os hynne possuem uma sorte lendária e um espírito aventureiro surpreendente.",
  appearance:
    "Baixos e de pés peludos, com rostos joviais e expressivos. Preferem roupas práticas, muitas vezes coloridas e confortáveis.",
  personality:
    "Otimistas, gulosos e extremamente sociáveis. Sua coragem costuma surpreender aqueles que os subestimam por seu tamanho.",
  commonReligions: "Nimb (Sorte) ou Valkaria (Ambição).",
  attributes: {
    attrs: [
