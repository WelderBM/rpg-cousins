...
import { Wand2, BookOpen, Scroll, ShoppingBag } from "lucide-react";
...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 w-full max-w-6xl px-4">
        {/* Card: Wizard */}
        <Link
          href="/wizard"
        ...
        >
          ...
          <p className="text-sm text-parchment-dark relative z-10">
            Visualize e gerencie seus personagens criados.
          </p>
        </Link>
